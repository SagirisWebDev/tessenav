...
/***/ "./src/tessenav-link/block.json":
/*!**************************************!*\
  !*** ./src/tessenav-link/block.json ***!
  \**************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"sagiriswd/tessenav-link","title":"TesseNav Link","category":"design","parent":["sagiriswd/tessenav"],"allowedBlocks":["sagiriswd/tessenav-link","sagiriswd/tessenav-submenu"],"description":"Add a custom link to TesseNav.","attributes":{"label":{"type":"string","role":"content"},"type":{"type":"string"},"description":{"type":"string"},"rel":{"type":"string"},"id":{"type":"number"},"opensInNewTab":{"type":"boolean","default":false},"url":{"type":"string"},"title":{"type":"string"},"kind":{"type":"string"},"isTopLevelLink":{"type":"boolean"}},"usesContext":["textColor","customTextColor","backgroundColor","customBackgroundColor","overlayTextColor","customOverlayTextColor","overlayBackgroundColor","customOverlayBackgroundColor","fontSize","customFontSize","showSubmenuIcon","maxNestingLevel","style"],"supports":{"reusable":false,"html":false,"__experimentalSlashInserter":true,"typography":{"fontSize":true,"lineHeight":true,"__experimentalFontFamily":true,"__experimentalFontWeight":true,"__experimentalFontStyle":true,"__experimentalTextTransform":true,"__experimentalTextDecoration":true,"__experimentalLetterSpacing":true,"__experimentalDefaultControls":{"fontSize":true}},"renaming":false,"interactivity":{"clientNavigation":true}},"textdomain":"sagiriswd","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/add-submenu.js");
...
/* harmony import */ var _link_ui__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./link-ui */ "./src/tessenav-link/link-ui.js");
...
/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../controls */ "./src/controls.js");
...
const NESTING_BLOCK_NAMES = ['sagiriswd/tessenav-link', 'sagiriswd/tessenav-submenu'];
...
const useIsDraggingWithin = elementRef => {
  const [isDraggingWithin, setIsDraggingWithin] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useState)(false);
...
const useIsInvalidLink = (kind, type, id, enabled) => {
  ...
  const postStatus = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    if (!isPostType) {
      return null;
    }
...
function getMissingText(type) {
  ...
  switch (type) {
    case 'post':
      ...
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Select post');
      break;
    case 'page':
      /* translators: label for missing page in navigation link block */
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Select page');
      break;
    case 'category':
      /* translators: label for missing category in navigation link block */
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Select category');
      break;
    case 'tag':
      /* translators: label for missing tag in navigation link block */
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Select tag');
      break;
    default:
      /* translators: label for missing values in navigation link block */
      missingText = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Add link');
  }
  return missingText;
}
...
function Edit({
  ...
  const [isLinkOpen, setIsLinkOpen] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useState)(isSelected && !url);
  // Store what element opened the popover, so we know where to return focus to (toolbar button vs navigation link text)
  const [openedBy, setOpenedBy] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useState)(null);
  // Use internal state instead of a ref to make sure that the component
  // re-renders when the popover's anchor updates.
  const [popoverAnchor, setPopoverAnchor] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useState)(null);
  const listItemRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useRef)(null);
  const isDraggingWithin = useIsDraggingWithin(listItemRef);
  const itemLabelPlaceholder = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Add label…');
  const ref = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useRef)();
  const linkUIref = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useRef)();
  const prevUrl = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_13__.usePrevious)(url);
  ...
  const [isEditingControl, setIsEditingControl] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useState)(false);
  const {
    isAtMaxNesting,
    isTopLevelLink,
    ...
    const isTopLevel = getBlockName(rootClientId) === 'sagiriswd/tessenav';
    const selectedBlockClientId = getSelectedBlockClientId();
    const rootNavigationClientId = isTopLevel ? rootClientId : getBlockParentsByBlockName(clientId, 'sagiriswd/tessenav')[0];
  ...
  const {
    getBlocks
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.store);
  ...
  const transformToSubmenu = () => {
    ...
    if (innerBlocks.length === 0) {
      innerBlocks = [(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)('core/group')];
      selectBlock(innerBlocks[0].clientId);
    }
    const newSubmenu = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)('sagiriswd/tessenav-submenu', {
      ...attributes,
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useEffect)(() => {
    ...
    if (!prevUrl && url && isLinkOpen && (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_7__.isURL)((0,_wordpress_url__WEBPACK_IMPORTED_MODULE_7__.prependHTTP)(label)) && /^.+\.[a-z]+/.test(label)) {
  ...
  } = (0,_utils__WEBPACK_IMPORTED_MODULE_16__.getColors)(context, !isTopLevelLink);
  function onKeyDown(event) {
    if (_wordpress_keycodes__WEBPACK_IMPORTED_MODULE_4__.isKeyboardEvent.primary(event, 'k')) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.useBlockProps)({
    ref: (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_13__.useMergeRefs)([setPopoverAnchor, listItemRef]),
    className: (0,clsx__WEBPACK_IMPORTED_MODULE_0__["default"])('sagiriswd-tn-link-item', {
      'is-editing': isSelected || isParentOfSelectedBlock,
      'is-dragging-within': isDraggingWithin,
      'has-link': !!url,
      'has-child': hasChildren,
      'has-text-color': !!textColor || !!customTextColor,
      [(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.getColorClassName)('color', textColor)]: !!textColor,
      'has-background': !!backgroundColor || customBackgroundColor,
      [(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.getColorClassName)('background-color', backgroundColor)]: !!backgroundColor
    }),
    style: {
  ...
  const classes = (0,clsx__WEBPACK_IMPORTED_MODULE_0__["default"])('sagiriswd-tn-link-item__content', {
    'sagiriswd-tn-link-link__placeholder': !url || isInvalid || isDraft
  });
  const missingText = getMissingText(type);
  /* translators: Whether the navigation link is Invalid or a Draft. */
  const placeholderText = `(${isInvalid ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Invalid') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Draft')})`;
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.BlockControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarGroup, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
          name: "link",
          icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_11__["default"],
          title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Link'),
          shortcut: _wordpress_keycodes__WEBPACK_IMPORTED_MODULE_4__.displayShortcut.primary('k'),
          onClick: event => {
            setIsLinkOpen(true);
            setOpenedBy(event.currentTarget);
          }
        }), !isAtMaxNesting && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
          name: "submenu",
          icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_10__["default"],
          title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Add submenu'),
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_controls__WEBPACK_IMPORTED_MODULE_17__.Controls, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)("a", {
        className: classes,
        children: [!url && !isEditingControl ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
          className: "sagiriswd-tn-link-link__placeholder-text",
          ...
          children: [!isInvalid && !isDraft && !isEditingControl && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.Fragment, {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.RichText, {
              ref: ref,
              identifier: "label",
              className: "sagiriswd-tn-link-item__label",
              value: label,
              ...
              onMerge: mergeBlocks,
              onReplace: onReplace,
              __unstableOnSplitAtEnd: () => insertBlocksAfter((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.createBlock)('sagiriswd/tessenav-link')),
              "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Navigation link text'),
              placeholder: itemLabelPlaceholder,
              withoutInteractiveFormatting: true
            }), description && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("span", {
              className: "sagiriswd-tn-link-item__description",
              children: description
            })]
          }), (isInvalid || isDraft || isEditingControl) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("div", {
            className: (0,clsx__WEBPACK_IMPORTED_MODULE_0__["default"])('sagiriswd-tn-link-link__placeholder-text', 'sagiriswd-tn-link-link__label', {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)("span", {
              ...
              `${(0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_9__.decodeEntities)(label)} ${isInvalid || isDraft ? placeholderText : ''}`.trim()
            })
          })]
        }), isLinkOpen && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_18__.jsx)(_link_ui__WEBPACK_IMPORTED_MODULE_14__.LinkUI, {
          ref: linkUIref,
          clientId: clientId,
          link: attributes,
          onClose: () => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/tessenav-link/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/tessenav-link/editor.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/tessenav-link/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./src/tessenav-link/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/tessenav-link/block.json");
/**
...
/******/ 		var installedChunks = {
/******/ 			"tessenav-link/index": 0,
/******/ 			"tessenav-link/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["tessenav-link/style-index"], () => (__webpack_require__("./src/tessenav-link/index.js")))
