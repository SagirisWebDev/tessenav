...
const {
  state,
  actions
} = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.store)('sagiriswd/tessenav', {
  state: {
    get roleAttribute() {
  ...
  actions: {
    ...
    handleMenuKeydown: (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.withSyncEvent)(event => {
      const {
        type,
