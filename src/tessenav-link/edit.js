...
const DEFAULT_BLOCK = { name: 'sagiriswd/tessenav-link' };
...
export default function Edit( {
	...
	const {
		...
		( select ) => {
			...
			const isTopLevel =
				getBlockName( rootClientId ) === 'sagiriswd/tessenav';
	...
	const transformToSubmenu = () => {
		...
		if ( innerBlocks.length === 0 ) {
			innerBlocks = [ createBlock( 'core/group' ) ];
	...
	const blockProps = useBlockProps( {
		...
		className: clsx( 'sagiriswd-tn-link-item', {
	...
	const classes = clsx( 'sagiriswd-tn-link-item__content', {
			...
			<div { ...blockProps }>
				...
				<a className={ classes }>
					...
					{ ! url && ! isEditingControl ? (
						<div className="sagiriswd-tn-link-link__placeholder-text">
						...
						<>
							{ ! isInvalid &&
								...
								! isEditingControl && (
									<>
										...
										/>
										{ description && (
											<span className="sagiriswd-tn-link-item__description">
												{ description }
											</span>
										) }
									</>
							...
							{ ( isInvalid || isDraft || isEditingControl ) && (
								<div
									className={ clsx(
										'sagiriswd-tn-link-link__placeholder-text',
										'sagiriswd-tn-link-link__label',
										{
