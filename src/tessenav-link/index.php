...
function render_block_core_navigation_link( $attributes, $content, $block ) {
	...
	$wrapper_attributes = get_block_wrapper_attributes(
		array(
			'class' => $css_classes . ' sagiriswd-tn-item' . ( $has_submenu ? ' has-child' : '' ) .
				( $is_active ? ' current-menu-item' : '' ),
			'style' => $style_attribute,
		)
	);
	$html               = '<li ' . $wrapper_attributes . '>' .
		'<a class="sagiriswd-tn-item__content" ';
	...
	$html .= '>' .
		...
		'<span class="sagiriswd-tn-item__label">';
	...
	if ( isset( $block->context['showSubmenuIcon'] ) && $block->context['showSubmenuIcon'] && $has_submenu ) {
		...
		$html .= '<span class="sagiriswd-tn__submenu-icon">' . block_core_navigation_link_render_submenu_icon() . '</span>';
	}
	...
	if ( $has_submenu ) {
		...
		$html .= sprintf(
			'<ul class="sagiriswd-tn__submenu-container">%s</ul>',
			$inner_blocks_html
		);
	}
