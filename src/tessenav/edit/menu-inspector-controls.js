...
import MenuInspectorList from './menu-inspector-list';
...
const MainContent = ( {
	...
	return (
		<div className="sagiriswd-tn__menu-inspector-controls">
			{ ! hasChildren && (
				<p className="sagiriswd-tn__menu-inspector-controls__empty-message">
					{ __( 'This Navigation Menu is empty.' ) }
				</p>
			) }
			<MenuInspectorList
				rootClientId={ clientId }
				ariaLabel="Navigation Block Structure"
			/>
			{/* <PrivateListView
				rootClientId={ clientId }
				isExpanded
	...
	return (
		<InspectorControls group="list">
			<PanelBody title={ null }>
				<HStack className="sagiriswd-tn-off-canvas-editor__header">
					<Heading
						className="sagiriswd-tn-off-canvas-editor__title"
						level={ 2 }
					>
						{ __( 'Menu' ) }
					</Heading>
